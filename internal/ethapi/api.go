...
import (
	...
	"github.com/Noaraud/geth-schnorr/accounts/scwallet"
	"github.com/Noaraud/geth-schnorr/common"
	"github.com/Noaraud/geth-schnorr/common/hexutil"
	"github.com/Noaraud/geth-schnorr/common/math"
...
//
// https://github.com/Noaraud/geth-schnorr/wiki/Management-APIs#personal_sign
...
//
// https://github.com/Noaraud/geth-schnorr/wiki/Management-APIs#personal_ecRecover
...
func SubmitTransaction(ctx context.Context, b Backend, tx *types.Transaction) (common.Hash, error) {
	...
	if tx.To() == nil {
		...
		log.Info("Hoge Submitted transaction", "fullhash", tx.Hash().Hex(), "recipient", tx.To())
	}
	return tx.Hash(), nil
}
